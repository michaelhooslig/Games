...
public class Orc
{
  ...
  private int monDmg = 3;
	private double monAttack = .4;
  private double monDefence = .4;
  ...
  public Orc(int hardness)
	{
		difficulty = hardness;
		monHealth = ((int)(Math.random()*5)+10) * difficulty;
	}
  ...
  public int monLoot()
  {
	...
	{
		return 10 * (int)(difficulty * levelBuff *1.5);
	}


	// combat loop starts      here        here          here          here    

	public int orcCombat(int Php, int PmeleeDmg, int PrangeDmg, double PmeleeAtt, double PrangeAtt, double dex, double back, double man, int throw1, int spark, int bolt, int fire, int ice, int quake, double cspell, double rspell)
	{
		health = Php;
		melee = PmeleeDmg;
		range = PrangeDmg;
		...
		if (true)
    {
      ...
      while (monHealth > 0)
      {
        ...
        System.out.println("\n Orc stats: Orc has " + monHealth + " Hit Points left and deals " + monDmg + " every attack.\n");
        ...
        {                  
           ...
           else
          {
            System.out.println("\n\nYou try and fail to punt the goblin back.");
				...
				//Bolt
				if (Fchoice.equals("b") && space == true && boltDmg > 0)
				{
					double rand = Math.random();
        ...
        else if (work1 == true)
        {
          ...
          {
            System.out.println("but manages to catch up to you in the process.");
            space = false;
          }
          else
          {
  ...
  {
    return "Orc has " + monHealth + " Hit Points left and deals " + monDmg + " every attack.";
  }
